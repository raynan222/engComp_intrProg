...
int main() {
	...
	texto[0] = (flag2 == 0? texto[contador-1]:texto[0]);
	
	flag2 = (flag2 == 1? 1 : (texto[contador - 2] != '\0'? 0 : 1));
	texto[1] =( flag2 == 0? texto[contador - 2]:texto[1] );
		
	flag2 = (flag2 == 1? 1 : (texto[contador - 3] != '\0'? 0 : 1));
	texto[2] =(flag2 == 0? texto[contador - 3]:texto[2] );
	
	flag2 = (flag2 == 1? 1 : (texto[contador - 4] != '\0'? 0 : 1));
	texto[3] =(flag2 == 0? texto[contador - 4]:texto[3] );
	
	flag2 = (flag2 == 1? 1 : (texto[contador - 5] != '\0'? 0 : 1));
	texto[4] =( flag2 == 0? texto[contador - 5]:texto[4] );
	
	flag2 = (flag2 == 1? 1 : (texto[contador - 6] != '\0'? 0 : 1));
	texto[5] =(flag2 == 0? texto[contador - 6]:texto[5] );
	
	flag2 = (flag2 == 1? 1 : (texto[contador - 7] != '\0'? 0 : 1)); 
	texto[6] =( flag2 == 0? texto[contador - 7]:texto[6] );
	
	flag2 = (flag2 == 1? 1 : (texto[contador - 8] != '\0'? 0 : 1)); 
	texto[7] =(flag2 == 0? texto[contador - 8]:texto[7] );
	
	flag2 = (flag2 == 1? 1 : (texto[contador - 9] != '\0'? 0 : 1)); 
	texto[8] =(flag2 == 0? texto[contador - 9]:texto[8] );
	
	flag2 = (flag2 == 1? 1 : (texto[contador - 10] != '\0'? 0 : 1)); 
	texto[9] =(flag2 == 0? texto[contador - 10]:texto[9] );
	
		
	printf("\n---------------------\n O Palindromo criado: %s\n---------------------\n", texto);
